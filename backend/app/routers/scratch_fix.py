filename = (
    r"c:\Users\KIIT0001\Downloads\Telegram Desktop\Scentrix\backend\app\routers\fragrances.py"
)
...
rest = (
    ...
    + content.split('@router.get("/{fragrance_id}", response_model=FragranceDetail)')[1]
)
...
rest2 = (
    ...
    + rest.split('@router.get("/search", response_model=List[FragranceSearchResult])')[1]
)

search_str = rest2.split(
