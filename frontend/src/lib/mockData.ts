...
const FRAGRANCES: Fragrance[] = [
  {
    ...
    middle_notes: ['Ginger', 'Nutmeg'],
    base_notes: ['Sandalwood', 'Cedar'],
  ...
  },
  {
    ...
    brand: 'Dior',
    name: 'Sauvage',
    top_notes: ['Bergamot', 'Pepper', 'Lavender'],
    middle_notes: ['Sichuan Pepper', 'Vetiver'],
  ...
  },
  {
    ...
    middle_notes: ['Rose', 'Birch'],
    base_notes: ['Musk', 'Oak Moss'],
    accords: ['fruity', 'chypre', 'fresh'],
    family: 'Chypre',
  },
  {
    id: '5',
    brand: 'YSL',
    name: 'Black Opium',
    top_notes: ['Coffee', 'Vanilla', 'White Flowers'],
    middle_notes: ['Jasmine', 'Bitter Almond'],
    base_notes: ['Patchouli', 'Cedarwood'],
    accords: ['sweet', 'coffee', 'floral'],
    family: 'Oriental',
  },
  {
    id: '6',
    brand: 'Hermes',
    name: 'Terre dHermes',
    top_notes: ['Orange', 'Flint', 'Pepper'],
    middle_notes: ['Pelargonium', 'Vetiver'],
    base_notes: ['Benzoin', 'Cedar'],
...
export function getQuizFragrances(count?: number): Fragrance[] {
  return count !== undefined ? FRAGRANCES.slice(0, count) : FRAGRANCES;
}